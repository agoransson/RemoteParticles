...
public class Messages {
	...
	protected static final byte CONNECTION_ACCEPTED = 0x00;
	
	/** Connection was refused: unacceptable protocol version */
	protected static final byte CONNECTION_REFUSED_VERSION = 0x01;
	
	/** Connection was refused: identifier rejected */
	protected static final byte CONNECTION_REFUSED_IDENTIFIER = 0x02;
	
	/** Connection was refused: server unavailable */
	protected static final byte CONNECTION_REFUSED_SERVER = 0x03;
	
	/** Connection was refused: bad username or password */
	protected static final byte CONNECTION_REFUSED_USER = 0x04;
	
	/** Connection was refused: not authorized */
	protected static final byte CONNECTION_REFUSED_AUTH = 0x05;
	 ...
	 * @throws IOException
	 */
	public static byte[] subscribe(int message_id, String subscribe_topic, byte subscribed_qos) throws IOException {
		ByteArrayOutputStream payload = new ByteArrayOutputStream();
	...
	protected static byte[] encode(int type, boolean retain, int qos,
		...
		case CONNECT:
			...
			variableHeader.write(MqttService.MQTT_PROTOCOL.getBytes("UTF-8").length);
			variableHeader.write(MqttService.MQTT_PROTOCOL.getBytes("UTF-8"));
			variableHeader.write(MqttService.MQTT_VERSION);
			// Connect flags
